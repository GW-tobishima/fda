# v15-merge-receipts-pr-v15-003

## これは何か

`EPIC-FDA-V1-5` の planned PR `PR-V15-003`（実 PR: [GW-tobishima/fda#4](https://github.com/GW-tobishima/fda/pull/4)）は、
...
に従い、`gh pr view 4 --json number,mergedAt,mergeCommit,url,title,headRefOid` 等で取得した
...
| merge commit (`merge_sha`) | `97d3bcd64496e3a99d3389528fa91050c4622a9a` |
| head SHA (`expected_head_sha`) | `d4d08979fd4f1a2e34504867ffd09a28e640a634` |
| merged_at | `2026-07-09T04:06:28Z` |
...
- 既存 run（`artifacts/runs/fda-start-1783555082/pr-4/` 等）の既存ファイルは一切変更していない。
