# v15-merge-receipts-pr-v15-002

## これは何か

`EPIC-FDA-V1-5` の planned PR `PR-V15-002`（実 PR: [GW-tobishima/fda#3](https://github.com/GW-tobishima/fda/pull/3)）は、
...
に従い、`gh pr view 3 --json number,mergedAt,mergeCommit,url,title,headRefOid` 等で取得した
...
| merge commit (`merge_sha`) | `3bd01ae149f9ceae034f85acf4e715b9a2a39cb4` |
| head SHA (`expected_head_sha`) | `6b855992c68311b99739ddbeae7b86844813ad27` |
| merged_at | `2026-07-09T01:53:00Z` |
...
- 既存 run（`artifacts/runs/fda-start-1783555082/pr-3/` 等）の既存ファイルは一切変更していない。
